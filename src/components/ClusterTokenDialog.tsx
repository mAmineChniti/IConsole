  ...
  if (isLoading) {
    return (
      <Dialog open={isOpen} onOpenChange={onOpenChange}>
        <DialogContent className="overflow-y-auto max-w-4xl md:max-w-2xl lg:max-w-4xl w-[95vw] max-h-[90vh] sm:max-w-[90vw]">
          <DialogHeader>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <Button
                    variant="ghost"
                    size="icon"
                    className="flex absolute top-2 right-2 justify-center items-center w-7 h-7 rounded-full cursor-pointer xs:w-8 xs:h-8 bg-background/80 group hover:bg-background/60"
