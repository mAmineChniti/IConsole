            ...
            <Form {...form}>
              ...
              >
                <Select defaultValue="RegionOne">
                  <SelectTrigger className="h-10 sm:h-12 w-full rounded-lg sm:rounded-xl border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-700 cursor-pointer">
                    <SelectValue placeholder="Select a region" />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="RegionOne">
                      <span className="truncate">RegionOne</span>
                    </SelectItem>
                  </SelectContent>
                </Select>
                <FormField
                      ...
                      <FormControl>
                        <div className="relative">
                          ...
                          <Button
                            ...
                            variant="ghost"
                            size="sm"
                            className="absolute right-2 top-1/2 transform -translate-y-1/2 h-6 w-6 sm:h-8 sm:w-8 p-0 hover:bg-slate-100 dark:hover:bg-slate-600 flex-shrink-0"
                ...
                {loginMutation.error && (
                  <div className="flex items-start gap-3 p-3 sm:p-4 text-sm text-red-700 bg-red-50 dark:bg-red-900/20 dark:text-red-400 border border-red-200 dark:border-red-800 rounded-lg sm:rounded-xl">
