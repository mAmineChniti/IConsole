import { VolumeTypes } from "@/components/VolumeTypes/VolumeTypes";
    ...
    <div className="w-full space-y-6 p-4 sm:p-6">
      <div className="space-y-1">
        ...
        <p className="text-muted-foreground">
          Manage your block storage types. Create, edit, or delete volume types
          to control storage options for your cloud infrastructure.
        </p>
      </div>
      <VolumeTypes />
    </div>
